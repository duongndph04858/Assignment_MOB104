				...
				<div class="row product-sort">
					<form action="sort-by-price.htm">
						<div class="form-group">
							<label for="sel">Sắp xếp theo:</label> <select
								class="form-control" id="sel" name="sellist">
					...
					<form class="mt-2" action="">
						<div class="form-check-inline">
							<label class="form-check-label" for="radio1"> <input
								...
								name="optradio" value="option1" checked>Tất cả
							</label>
						</div>
						<br>
						<div class="form-check-inline">
							<label class="form-check-label" for="radio2"> <input
								...
								name="optradio" value="option2">Dưới 1.000.000 đ
							</label>
						</div>
						<br>
						<div class="form-check-inline">
							<label class="form-check-label" for="radio3"> <input
								...
								name="optradio" value="option3">Từ 1.000.000 đ đến
								2.000.000 đ
							</label>
						</div>
						<br>
						<div class="form-check-inline">
							<label class="form-check-label" for="radio4"> <input
								...
								name="optradio" value="option4">Từ 2.000.000 đ đến
								5.000.000 đ
							</label>
						</div>
						<br>
						<div class="form-check-inline">
							<label class="form-check-label" for="radio5"> <input
								...
								name="optradio" value="option5">Từ 5.000.000 đ đến
								10.000.000 đ
							</label>
						</div>
						<br>
						<div class="form-check-inline">
							<label class="form-check-label" for="radio6"> <input
								...
								name="optradio" value="option6">Trên 10.000.000 đ
							</label>
						</div>
					</form>
				</div>
